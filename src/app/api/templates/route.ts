...
//     if (userPackage?.stripeCustomerId) {
//       const plan = pricingPlans.find(
//         (plan: Plan) => plan.stripePriceId === userPackage.stripeCustomerId
//       );

//       if (plan) {
//         userTier = plan.tier.toLowerCase();
//       } else {
//         console.warn('No matching SubscriptionPlan found for stripePriceId:', userPackage.stripeCustomerId);
//       }
//     }
