...
//     const userPackage = await db.userPackage.findUnique({
//       where: { userId },
//       select: { stripePurchaseId: true, stripePriceId: true },
//     });

//     if (userPackage?.stripePurchaseId && userPackage.stripePriceId) {
//       console.log('📊 Retrieved UserSubscription:', userSubscription);

//       const plan = pricingPlans.find(
//         (plan: Plan) => plan.stripePriceId === userPackage.stripePriceId
//       );
...
//       console.log('📊 No matching SubscriptionPlan found for stripePriceId:', userPackage.stripePriceId);
//     }
