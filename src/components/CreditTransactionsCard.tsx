...
const CreditTransactionsCard: React.FC<CreditTransactionsCardProps> = ({ transactions }) => {
  if (transactions.length === 0) {
    return (
      <div className="p-4 bg-gray-100 border border-gray-300 rounded-md">
        <h3 className="text-lg font-medium text-gray-800">لا توجد معاملات ائتمان</h3>
  ...
  return (
    <div className="p-4 bg-purple-100 border border-purple-300 rounded-md">
      <h3 className="text-lg font-medium text-purple-800">معاملات الاعتمادات الأخيرة</h3>
