...
<div className="px-4 lg:px-8 space-y-4 flex flex-col items-center">
  <div className="text-muted-foreground text-sm text-center">
    {isPro ? "أنت حالياً على الخطة المدفوعة." : "أنت حالياً على الخطة المجانية."}
  </div>
  <SubscriptionButton isPro={isPro} />
</div>

      {/* <div className="px-4 lg:px-8 space-y-4 justify-items-center">
