...
export default function C2aContent() {
  ...
  return (
      ...
      <div className="">
        ...
        <div className="">
        <h4 className="text-2xl p-4 font-extrabold leading-tight">{`سجل وجرب الخدمات مجاناً `}</h4>
          
          <div className=""> 
            <h4 className="text-2xl p-2 leading-tight">{`احدث أدوات الذكاء الصناعي باللغة العربية`}</h4>
          </div> 
        </div>
      </div>
